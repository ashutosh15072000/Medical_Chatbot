			...
			$(document).ready(function() {
				$("#messageArea").on("submit", function(event) {
					...
					var userHtml = '<div class="d-flex justify-content-end mb-4"><div class="msg_cotainer_send">' + rawText + '<span class="msg_time_send">'+ str_time + '</span></div><div class="img_cont_msg"><img src="https://i.ibb.co/d5b84Xw/Untitled-design.png" width="50px" class="rounded-circle user_img_msg"></div></div>';
